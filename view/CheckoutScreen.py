...
class CheckoutScreen(tk.Toplevel):
    ...
    def order_items(self):
          ...
          self.confirm_label=tk.Label(self, text=f"Thanks for placing the order! Your order is confirmed.", bg="white", fg="Black", font=("Microsoft YaHei UI Light", 13,"bold"))
          ...
          self.print_button = tk.Button(self, text="Print", command=self.print_order,width=10,border=0,bg='dodgerblue4',fg='white',font=("Microsoft YaHei UI Light", 10, "bold"))
          self.print_button.place(x=350, y=425)
          self.Email_button = tk.Button(self, text="Email",width=10,border=0,bg='dodgerblue4',fg='white',font=("Microsoft YaHei UI Light", 10, "bold"))
          ...
          self.total_label=tk.Label(self.order_frame, text=f"You pay: {self.total}", bg="floralwhite", font=("Microsoft YaHei UI Light", 10, "bold"))
          self.total_label.place(x=20, y=10)
          self.delivery_label=tk.Label(self.order_frame, text="Free shipping & handling ",  bg="floralwhite",fg="dodgerblue4", font=("Microsoft YaHei UI Light", 8))
          self.delivery_label.place(x=20, y=35)
          self.delivery_label=tk.Label(self.order_frame, text="Estimated delivery time: 3-4 business days ",  bg="floralwhite",fg="dodgerblue4", font=("Microsoft YaHei UI Light", 8))
          ...
          self.address = tk.Label(self.order_frame, text=f"Address: {self.user.address+','+self.user.city+','+self.user.state+'-'+self.user.zipcode}", bg="floralwhite",
                                      font=("Microsoft YaHei UI Light", 10))
